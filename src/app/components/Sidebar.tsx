...
const navItems = [
  ...
  { path: '/dashboard/passport/current_user', label: 'Passport', icon: Fingerprint },
    ...
    <aside className="w-64 border-r border-border-subtle bg-sidebar flex flex-col h-full">
      <div className="p-6 border-b border-border-subtle">
        <Link to="/dashboard" className="flex items-center gap-3 group">
          ...
          <div>
            <h1 className="text-xl tracking-tight text-foreground group-hover:text-primary transition-colors">
              Sloan
            </h1>
            ...
            <Link
              ...
              className={`
                ...
                ${isActive
                  ...
                  : 'text-foreground-muted hover:text-foreground hover:bg-accent-dim/50'
                }
              `}
            >
